 ...
 /*public function dispquestion($id = NULL)
		...
		public function delivery_area() {
			...
			if(!empty($this->request->data)){
				...
				$this->request->data['Deliverycharge']['name'] = $this->request->data['delcharges']['zone_name'];
		...
		public function add_del_countries() {
			...
			if(!empty($this->request->data)){
				...
				$countrycode = $this->request->data['dcountry'];
...
//echo $couponcode; echo $id; die;
		...
		function currency_code($currency) {
			...
			$this->loadModel('Forexrate');
//$currency = 'BRL';
			$currency_name = array('AUD' => 'Australian Dollar', 'BRL' => 'Brazilian Real', 'CAD' => 'Canadian Dollar', 'CZK' => 'Czech Koruna', 'DKK' => 'Danish Krone', 'EUR' => 'Euro', 'HKD' => 'Hong Kong Dollar', 'HUF' => 'Hungarian Forint', 'ILS' => 'Israeli New Sheqel', 'JPY' => 'Japanese Yen', 'MYR' => 'Malaysian Ringgit', 'MXN' => 'Mexican Peso', 'NOK' => 'Norwegian Krone', 'NZD' => 'New Zealand Dollar', 'PHP' => 'Philippine Peso', 'PLN' => 'Polish Zloty', 'GBP' => 'Pound Sterling', 'RUB' => 'Russian Ruble', 'SGD' => 'Singapore Dollar', 'SEK' => 'Swedish Krona', 'CHF' => 'Swiss Franc', 'TWD' => 'Taiwan New Dollar', 'THB' => 'Thai Baht', 'TRY' => 'Turkish Lira', 'USD' => 'U.S. Dollar');
	
			$currency_symbol = array('AUD' => '$', 'BRL' => 'R$', 'CAD' => '$', 'CZK' => 'Kč', 'DKK' => 'kr.', 'EUR' => '€', 'HKD' => '$', 'HUF' => 'Ft', 'ILS' => '₪', 'JPY' => '¥', 'MYR' => 'RM', 'MXN' => 'Mex$', 'NOK' => 'kr', 'NZD' => '$', 'PHP' => '₱', 'PLN' => 'zł', 'GBP' => '£', 'RUB' => 'руб', 'SGD' => 'S$', 'SEK' => 'kr', 'CHF' => 'SFr.', 'TWD' => '$', 'THB' => '฿', 'TRY' => 'も', 'USD' => '$');
