...
<div id="itemaddid"  style="display:none;" class="popup ly-title update add-to-items">
	<div class="default">
		...
		<ul class="fromweb">
			...
			<li>
				<a href="mailto:info@hitasoft.com" >
...
<!-- /popups -->
	...
	<!-- <div id="footer-container">
		<span class="website">Fancy clone script</span>
		<span class="poweredby">
			<?php echo __('Powered by'); ?> <a href="http://www.simplit.co" target="_blank">Simpl!it Services Technologies</a>
		</span>
	</div> -->
