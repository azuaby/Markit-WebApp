...
<?php
	echo "<div class='containerdiv'>";
		...
		echo $this->Form->Create('Forexrate',array('url'=>array('controller'=>'/','action'=>'/admin/add/currency'),'id'=>'Categoryform'));
			...
			echo $this->Form->input('Currency Symbol', array('options' => array('$' => '$', 'R$' => 'R$', 'C$' => 'C$', 'Kč' => 'Kč', 'kr.' => 'kr.', '€' => '€', 'HK$' => 'HK$', 'Ft' => 'Ft', '₪' => '₪',  '£' => '£', 'RM' => 'RM', 'Mex$' => 'Mex$', 'kr' => 'kr', '₱' => '₱', 'zł' => 'zł', 'руб' => 'руб', 'CHF' => 'CHF', 'NT$' => 'NT$', '฿' => '฿', 'も' => 'も', '¥' => '¥'  ), 'value' => ''.$_SESSION['cur'].'', 'type' => 'hidden'));
