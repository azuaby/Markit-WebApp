...
?>
		...
		<footer>
			<p>
				 <hr>
	<p class="pull-right">A <a href="#" target="_blank">Fancyclone script</a> by <a style="text-decoration:none;" data-ajax="false" href="http://hitasoft.com" target="_blank">Simpl!it Services</a></p>
