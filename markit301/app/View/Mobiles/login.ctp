...
if(mobileOS == 'iOS')
{
disp = '<center><a href="https://itunes.apple.com/us/app/fantacy/id721103045?mt=8" target="_blank" title="Markit for iPhone" class="playstorelink"><div class="appstore"></div></a></center>';
}
else if(mobileOS == 'Android')
{
disp = '<center><a href="https://play.google.com/store/apps/details?id=com.hitasoft.apps.fantacy" target="_blank" title="Markit for Android" class="playstorelink"><div class="googlestore"></div></a></center>';
}
document.write(disp);
