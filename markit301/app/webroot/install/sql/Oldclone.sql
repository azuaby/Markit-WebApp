...
CREATE TABLE IF NOT EXISTS `fc_carts` (
  ...
  `shipping_charg` float DEFAULT NULL,
  `shipping_status` enum('enable','disable') CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `fc_delivery_charges` (
  ...
  `regulr_chrge` float DEFAULT NULL,
  `expres_chrge` float DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `fc_items` (
  ...
  `delivery_type` varchar(60) DEFAULT NULL,
...
(1, 'Fantacy beta', 'online purchase', 'Fantacy', 'Fantacy', 'yes', 'yes', 'noreply@fantacyscript.com', 'noreply@hitasoft.com', 'Fantacy', 'noreply@hitasoft.com', 'noreplyhitasoft', 'enable', 465, '2014-09-12 11:00:52', '', '', '', '', 'Fantacy', 'Fantacy''d', 'logo.png', 'fantacylike.png', 'sandbox', 'rajahussain64@yahoo.com', '{"profile_image_view":"square","credit_amount":"23"}', '{"language":"eng"}', '{"title":"FANTACY GIFT CARD","description":"Markit Gift card is the Feature which is used for the User, User can buy send receive the gift card to the friends, And the User can receive the Gift card code and use for the purchase.","amounts":"10,20,30,50,100,1000,1008,2000,5000,10000","image":"1403790138.jpg","time":1403790268}', '{"paymentMode":"paypalnormal","apiUserId":null,"apiPassword":null,"apiSignature":null,"apiApplicationId":null}', NULL, 'enable', 'Powered by <a href="http://www.simplit.co/">Simpl!it Services Technology Solutions</a>', 'Markit Multi vendor eCommerce Script v1.3.5', 'yes');
-- --------------------------------------------------------
...
INSERT INTO `fc_areas` (`id`,`state_id`, `code`, `area`) VALUES
(1, '1' ,'GJU', 'Junagadh'),
(2, '1' ,'RJT', 'Rajkot'),
(3, '1' ,'DJH', 'Somnath'),
(4, '2' ,'MJP', 'Jaipur'),
...
(1, 'Admin', 'admin', 'admin', 'admin', '4245999507644fc247980e3cc7dd19940c6c6bfc', 'admin@fantacy.com', 'Chennai', '', '', '', 'god', 'enable', '', NULL, NULL, '2013-02-28 12:02:24', '2013-03-15', '2013-02-28 12:02:24', 'normal', NULL, NULL, NULL, 0, '', '0', '', 'male', NULL, '2013-07-29 22:28:07', 1, 1, 1, 0, 0, 0, 0, 0, 0),
(2, 'demo', 'demo', 'Demo', NULL, '4245999507644fc247980e3cc7dd19940c6c6bfc', 'demo@fantacy.com', '', '', '', '', 'normal', 'enable', '', NULL, NULL, '2013-07-31 05:25:11', '0000-00-00', '2013-07-31 08:55:11', 'normal', NULL, NULL, NULL, 0, '', '0', 'NbHE953O', NULL, NULL, '2013-07-31 06:20:21', 1, 1, 1, 0, 0, 0, 0, 0, 0);
-- --------------------------------------------------------
