				...
				if(!empty($main_catdata)){
					...
					foreach($super_sub_catdata as $key=>$temp){
						...
						echo "<tr id='catgy".$secid."'>";
							...
							if(!empty($mnscns[$vsec_parent])){
								//echo "<td>".$mnscns[$vsec_parent]."</td>";
								echo "<td>".$this->Html->link($mnscns[$vsec_parent],array('controller'=>'/','action'=>'/admin/edit/category/'.$sec_parent.'~'.$cat_urlnme[$vsec_parent]))."</td>";
							}else{
								echo "<td>-</td>";
							}
							if(!empty($mnscns[$vsub_sec_parent])){
								//echo "<td>".$mnscns[$vsub_sec_parent]."</td>";
								echo "<td>".$this->Html->link($mnscns[$vsub_sec_parent],array('controller'=>'/','action'=>'/admin/edit/category/'.$sub_sec_parent.'~'.$cat_urlnme[$vsub_sec_parent]))."</td>";
							}else{
								echo "<td>-</td>";
							}
						...
						?>
							<td> <a href="<?php echo SITE_URL.'admin/edit/category/'.$secid;?>"> <span class='btn btn-danger'><i class='icon-edit'></i></span></a></td>
