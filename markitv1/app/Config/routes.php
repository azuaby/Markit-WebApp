 ...
 */
	...
	/****Help links *****/
	Router::connect('/help',array('controller'=>'markithelps', 'action' => 'faq'));
	Router::connect('/help/faq',array('controller'=>'markithelps', 'action' => 'faq'));
	Router::connect('/help/contact',array('controller'=>'markithelps', 'action' => 'contact'));
	Router::connect('/help/copyright_policy',array('controller'=>'markithelps', 'action' => 'copyrights'));
	Router::connect('/help/terms_of_sale',array('controller'=>'markithelps', 'action' => 'termsofsale'));
	Router::connect('/help/terms_service',array('controller'=>'markithelps', 'action' => 'termsofservice'));
	Router::connect('/help/terms_merchant',array('controller'=>'markithelps', 'action' => 'termsofmerchant'));
	Router::connect('/help/privacy',array('controller'=>'markithelps', 'action' => 'privacy'));
	Router::connect('/addto/*',array('controller'=>'markithelps', 'action' => 'addto'));
	Router::connect('/mobileapps/*',array('controller'=>'markithelps', 'action' => 'mobile'));
    Router::connect('/mobile/mobileapps/*',array('controller'=>'mobilemarkithelps', 'action' => 'mobileapps'));
